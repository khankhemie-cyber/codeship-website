    ...
    <div className="bg-[#FAF8F4]">
      ...
      <section className="py-20">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-[#001532] text-center mb-10">School Programs</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-16">
            {[
              ...
              <div key={prog.title} className={`bg-white rounded-2xl p-6 shadow-sm flex gap-4 ${prog.border}`}>
                <div>
                  <h3 className="font-bold text-[#001532] mb-1">{prog.title}</h3>
          ...
          {/* Benefits */}
          <div className="bg-[#001532] rounded-2xl p-8 text-white mb-16">
          ...
          {/* How it works */}
          <div className="mb-16">
            <h2 className="text-2xl font-bold text-[#001532] text-center mb-8">How It Works</h2>
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              {[
                ...
                <div key={s.step} className="text-center bg-white rounded-2xl p-5 shadow-sm">
                  <div className="w-12 h-12 bg-[#E5A823] text-[#001532] rounded-full flex items-center justify-center font-bold text-lg mx-auto mb-3">
                    {s.step}
                  </div>
                  <h3 className="font-bold text-[#001532] mb-1">{s.title}</h3>
          ...
          <div className="bg-white rounded-2xl shadow-md p-8">
            <h2 className="text-2xl font-bold text-[#001532] mb-6 text-center">Request School Partnership Information</h2>
            <SchoolContactForm />
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-[#FAF8F4]">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-[#001532] text-center mb-8">School FAQ</h2>
