      ...
      <section className="py-16">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-2xl shadow-sm p-8 space-y-8 text-gray-700 text-sm">
            <div>
              <h2 className="text-xl font-bold text-[#071B3B] mb-3">1. Acceptance of Terms</h2>
              <p>
            ...
            <div>
              <h2 className="text-xl font-bold text-[#071B3B] mb-3">2. Website Use</h2>
              <p>
            ...
            <div>
              <h2 className="text-xl font-bold text-[#071B3B] mb-3">3. Franchise Information Disclaimer</h2>
              <p>
            ...
            <div>
              <h2 className="text-xl font-bold text-[#071B3B] mb-3">4. Program Enrollment</h2>
              <p>
            ...
            <div>
              <h2 className="text-xl font-bold text-[#071B3B] mb-3">5. Intellectual Property</h2>
              <p>
            ...
            <div>
              <h2 className="text-xl font-bold text-[#071B3B] mb-3">6. Limitation of Liability</h2>
              <p>
            ...
            <div>
              <h2 className="text-xl font-bold text-[#071B3B] mb-3">7. Governing Law</h2>
              <p>
            ...
            <div>
              <h2 className="text-xl font-bold text-[#071B3B] mb-3">8. Changes to Terms</h2>
              <p>
            ...
            <div>
              <h2 className="text-xl font-bold text-[#071B3B] mb-3">9. Contact</h2>
              <p>
