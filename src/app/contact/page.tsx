        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="bg-white rounded-2xl shadow-md p-8">
              <h2 className="text-2xl font-bold text-[#071B3B] mb-6">Send Us a Message</h2>
              <ContactForm />
            </div>
            ...
            <div className="space-y-6">
              <div>
                <h2 className="text-2xl font-bold text-[#071B3B] mb-6">Contact Information</h2>
                <div className="space-y-4">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <p className="font-semibold text-[#071B3B]">Email</p>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <p className="font-semibold text-[#071B3B]">Headquarters</p>
              ...
              <div className="bg-[#138A9A]/10 rounded-2xl p-6">
                <h3 className="font-bold text-[#071B3B] mb-2">Response Time</h3>
