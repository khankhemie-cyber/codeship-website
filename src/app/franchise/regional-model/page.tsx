      ...
      <section className="py-20">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div>
              <h2 className="text-2xl font-bold text-[#3D4466] mb-4">Regional Development Rights</h2>
            ...
            <div className="space-y-4">
              <h2 className="text-2xl font-bold text-[#3D4466] mb-4">Regional Model Features</h2>
              {[
