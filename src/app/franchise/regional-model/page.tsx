      ...
      <section className="py-20">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div>
              <h2 className="text-2xl font-bold text-[#071B3B] mb-4">Regional Development Rights</h2>
              ...
              <h3 className="font-bold text-[#071B3B] mb-3">Ideal For</h3>
            ...
            <div className="space-y-4">
              <h2 className="text-2xl font-bold text-[#071B3B] mb-4">Regional Model Features</h2>
              {[
      ...
      <section className="py-16 bg-[#071B3B] text-center">
        <div className="max-w-2xl mx-auto px-4">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            ...
            <Link href="/contact" className="border-2 border-white text-white font-bold px-6 py-3 rounded-xl hover:bg-white hover:text-[#071B3B] transition-colors">
