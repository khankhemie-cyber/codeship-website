...
const explorers: Campaign = {
  ...
  offerHeadline: "Book a free trial class",
  offerBody: "See Explorers in action before you commit — no long-term contract, just one class to find out if it's the right fit.",
...
const builders: Campaign = {
  ...
  offerHeadline: "Book a free trial class",
  offerBody: "See Builders in action before you commit — no long-term contract, just one class to find out if it's the right fit.",
...
const developers: Campaign = {
  ...
  offerHeadline: "Book a free trial class",
  offerBody: "See Developers in action before you commit — no long-term contract, just one class to find out if it's the right fit.",
...
const engineers: Campaign = {
  ...
  offerHeadline: "Book a free trial class",
  offerBody: "See Engineers in action before you commit — no long-term contract, just one class to find out if it's the right fit.",
...
const quebecFr: Campaign = {
  ...
  offerHeadline: "Réservez un cours d'essai gratuit",
  offerBody: "Découvrez Explorateurs avant de vous engager — aucun contrat à long terme, un seul cours pour voir si c'est le bon choix.",
  faq: [
    {
