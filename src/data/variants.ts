...
export const VARIANTS: Record<LPSlug, Record<VariantId, Variant>> = {
  explorers: {
    a: { heroImage: "https://images.unsplash.com/photo-1503676260728-1c00da094a0b?w=900&q=80", ctaLabel: "Register Now" },
    b: {
  ...
  builders: {
    a: { heroImage: "https://images.unsplash.com/photo-1427504494785-3a9ca7044f45?w=900&q=80", ctaLabel: "Register Now" },
    b: {
  ...
  developers: {
    a: { heroImage: "https://images.unsplash.com/photo-1509062522246-3755977927d7?w=900&q=80", ctaLabel: "Register Now" },
    b: {
