  ...
  return (
    <section className="py-16 bg-white overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-10 text-center">
        <h2 className="text-3xl font-bold text-[#3D4466]">What Families Are Saying</h2>
      </div>
      ...
      <div className="relative">
        ...
        <div className="flex gap-6 marquee-track">
          {items.map((t, i) => (
            <div
              key={i}
              className="flex-none w-80 bg-[#FAFAFA] border border-gray-100 rounded-2xl p-6 shadow-sm"
            >
