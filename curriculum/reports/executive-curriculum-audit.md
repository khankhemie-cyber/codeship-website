...
|----|-------|----------------|--------------|--------------------|--------------------|------------------------|
| U-1 | ~~Prior lesson-level curriculum artifacts could not be located~~ **RESOLVED 2026-07-15:** the owner supplied the complete production kit (64 PDFs). Diff performed: all 20 projects, Big Ideas, outcomes, and brand rules match this library and the website canon. One structural difference found and logged as **R-7**: the kit realizes a semester as 4 classes with 10-question quizzes (rubric levels *emerging/developing/meeting/exceeding*) vs. this library's 5-session/5-question realization — the print kit takes precedence; markdown manuals to be reconciled in v1.1. See `curriculum/print/print-readiness-report.md`. | — | — | — | — | Reconcile markdown manuals to the kit's structural parameters in v1.1 |
